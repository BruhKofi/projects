	...
	\begin{itemize}
		\item
			...
			{ \small
				...
				\renewcommand{\baselinestretch}{1}
				 \normalsize
					{\resitem{Developed a web application for an international transportation company}}
					{\resitem{Used Oracle ADF, Coherence, Hibernate, and JUnit}}
