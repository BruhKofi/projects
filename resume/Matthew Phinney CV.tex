...
\begin{multicols}{3}
	...
	\large
		...
		{ \small
				...
				\renewcommand{\baselinestretch}{1}
				 \small
				 	%\resitem{Set up job to build source code and run unit tests on each commit to SVN}
...
\large
	\begin{itemize}
		\item
			\ressubheading{\href{http://www.princeton.com/}{Princeton Consultants}}{Princeton, NJ}{Developed a web application for a transportation company} {October 2012-August 2014}
			
			{ \small
				\begin{itemize}
				\renewcommand{\baselinestretch}{1}
				 \normalsize
				 	\resitem{Set up Hudson jobs to build source code, run unit tests, and execute deployment process}
					...
					%{\resitem{Worked with our clients to deliver, install, and deploy application on their servers}}
				\end{itemize}
			}
	...
	\begin{itemize}
		\item
			\ressubheading{{Oxford University}}{Oxford, UK}{Numerical research with C++} {June 2011-September 2011}
			
			{ \small
				\begin{itemize}
				\renewcommand{\baselinestretch}{1}
				 \normalsize
					{\resitem{Developed and implemented C++ library for linear algebra}}
					\resitem{Implemented five Monte Carlo algorithms for the simulation of chemical reactions}
					\resitem{Imported data from simulations into MatLab and compared plots of error vs runtime}
				\end{itemize}
			}
	...
	\begin{itemize}
		\item
			...
			{ \small
				...
				\renewcommand{\baselinestretch}{1}
				 \normalsize
					{\resitem{\href{http://www.gatescambridge.org/our-scholars/Profile.aspx?ScholarID=5646}{Gates Cambridge Scholar}: Merit based scholarship to Cambridge (95 selected from c. 4000)}}
				\end{itemize}
			}
		\item
			\ressubheading{\href{http://www.ox.ac.uk}{Oxford University}}{Oxford, UK}{\href{https://www.maths.ox.ac.uk/members/students/postgraduate-courses/msc-mmsc}{MSc Mathematical Modelling and Scientific Computing} -- with distinction} {September 2011}
		...
		{ \small
				...
				\renewcommand{\baselinestretch}{1}
				 \normalsize
					{\resitem{\href{http://www.act.org/goldwater/}{Goldwater Scholar}: Merit based science scholarship (c. 300 selected from c. 1200)}}
				\end{itemize}
			}
...
\resheading{\Large{Personal}}\vspace{0.05in}\\
\normalsize
\vspace{0.15in}
\fbox{\parbox{\textwidth}{Aside from coding, I enjoy surfing, cooking, hiking, basketball, and travel.  I played pipe organ professionally in high school and college, and have worked on service projects in Nepal and Uganda.}}
