...
public class AlbersSquares {
    ...
    public static void main(String[] args) {
        ...
        StdDraw.filledSquare(.1, .1, .05);
        StdDraw.setPenColor(c2);
        StdDraw.filledSquare(.1, .1, .025);

        // second Albers square
        StdDraw.setPenColor(c2);
        StdDraw.filledSquare(.4, .1, .05);
        StdDraw.setPenColor(c1);
        StdDraw.filledSquare(.4, .1, .025);

        // third Albers square
        StdDraw.setPenColor(c3);
        StdDraw.filledSquare(.6, .1, .05);
        StdDraw.setPenColor(c1);
        StdDraw.filledSquare(.6, .1, .025);

        // fourth Albers square
        StdDraw.setPenColor(c1);
        StdDraw.filledSquare(.1, .4, .05);
        StdDraw.setPenColor(c3);
        StdDraw.filledSquare(.1, .4, .025);

        // fifth Albers square
        StdDraw.setPenColor(c2);
        StdDraw.filledSquare(.4, .4, .05);
        StdDraw.setPenColor(c3);
        StdDraw.filledSquare(.4, .4, .025);

        // sixth Albers square
        StdDraw.setPenColor(c3);
        StdDraw.filledSquare(.6, .4, .05);
        StdDraw.setPenColor(c2);
        StdDraw.filledSquare(.6, .4, .025);
    } 
} 
